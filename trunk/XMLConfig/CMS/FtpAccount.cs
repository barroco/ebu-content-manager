...
namespace XMLConfig.CMS
{
    ...
    public class FtpAccount
    {
        ...
        public Boolean externalProcess = false;
        

        internal void print()
        {
            Console.WriteLine("FTP : " + server + " " + login + " " + password + " " + minperiod + " ");
        }

        public override string ToString()
        {
            return server + ", " + login + ", " + password + ", " + minperiod + ", extProc:" + ((externalProcess)?"yes":"no");
        } 
    }
}
